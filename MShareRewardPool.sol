...
contract MShareRewardPool {
    ...
    struct PoolInfo {
        ...
        uint256 allocPoint; // How many allocation points assigned to this pool. mshare to distribute per block.
        uint256 lastRewardTime; // Last time that mshare distribution occurs.
        uint256 accMSharePerShare; // Accumulated mshare per share, times 1e18. See below.
    ...
    // View function to see pending mshare on frontend.
    ...
    // Safe mshare transfer function, just in case if rounding error causes pool to not have enough mshare.
