...
contract Boardroom is ShareWrapper, ContractGuard {
    ...
    function getMayaDogePrice() external view returns (uint256) {
        return treasury.getMayaDogePrice();
    }
    ...
    function claimReward() public updateReward(msg.sender) {
        ...
        if (reward > 0) {
            ...
            mayadoge.safeTransfer(msg.sender, reward);
        ...
        onlyOperator
    {
        ...
        mayadoge.safeTransferFrom(msg.sender, address(this), amount);
